        ...
        <li>
            <div class="row" style="margin-top: 30px;">
                <div class="col-md-12 card h-25 bg-info bg-opacity-75">
                    <table>
                        <tr>
                            <td class="card2"><img src="img/user.jpg" class="rounded-circle card-img-top" height="200px"></td>
                            <td style="padding-left: 5% ;">
                                <h2 class="text-black">{{$dosen}}</h2>
                                <small class="text-muted">{{$dosen}} | Posted on 21 Mar 2022</small>
                                <p> Nama : {{$dosen}} <br> No.hp : 081385678493</p>
                            </td>
                        </tr>
                    </table>
                </div>
